...
综合数据质量与使用成本，我将[理杏仁数据接口](https://www.lixinger.com/open/api/doc)封装成了 R 程序包：[lixingr](https://github.com/tanchangde/lixingr)。目前已完成 A 股上市公司、H 股上市公司接口封装，期待你试用，反馈，共同完善。
