...
请结合 [Tableau Server 发行说明](https://help.tableau.com/current/server-linux/zh-cn/whatsnew_server.htm)，选择你希望部署的版本。本例实测版本为：2023.1.22。因为之后的版本，没有激活试用许可证的选项，还需要联系销售处理。
...
若要了解试用 Tableau Server 的选项，需要与销售联系。
